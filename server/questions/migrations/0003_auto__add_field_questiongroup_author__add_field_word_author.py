...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'QuestionGroup.author'
        db.add_column(u'questions_questiongroup', 'author',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True),
                      keep_default=False)

        # Adding field 'Word.author'
        db.add_column(u'questions_word', 'author',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'QuestionGroup.author'
        db.delete_column(u'questions_questiongroup', 'author_id')

        # Deleting field 'Word.author'
        db.delete_column(u'questions_word', 'author_id')
    ...
    models = {
        ...
        u'questions.question': {
            ...
            'group': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['questions.QuestionGroup']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
